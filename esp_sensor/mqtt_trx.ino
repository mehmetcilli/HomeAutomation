...
const char* mqttUser = "captor";
const char* mqttPassword = "publish";
int entrer;
...
void setup() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("CAPTOR", mqttUser, mqttPassword )) {
...
void loop() {
  ...
  client.publish("value/light", numberString);
